        ...
        <form action="{{ route('blog.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" id='title' value="{{ old('title') }}"
                    class="@error('title') border-red-300 @enderror mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-4 py-2 focus:ring-4 focus:ring-blue-500 focus:border-blue-500">
                @error('title')
            ...
            <div>
                ...
                <textarea type="text" name="description" id='description'
                    class="@error('description') border-red-300 @enderror mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-4 py-2  focus:ring-4 focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
                @error('description')
                    <div class="mt-1 p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50">{{ $message }}</div>
                @enderror
            </div>
